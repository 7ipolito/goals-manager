      ...
      <Layout>
        ...
        >
          ...
          <div className="hidden lg:block">
            {!goals.loading &&
              !goalsComplete.loading &&
              !goals.error &&
              !goalsComplete.error && (
                <>
                  <Statistic
                    valueStyle={{ color: "white" }}
                    value={goals.data.goals.length}
                    prefix={<RiTaskLine />}
                    suffix={<p>Goals</p>}
                  />
                  <Statistic
                    ...
                    value={
                      ...
                      goalsComplete.data.goalsComplete.length
                    }
                    prefix={<RiProgress7Line />}
                    suffix={<p>In Progress</p>}
                  />
                  <Statistic
                    valueStyle={{ color: "white" }}
                    value={goalsComplete.data.goalsComplete.length}
                    prefix={<RiTaskFill />}
                    suffix={<p>Done</p>}
                  />
                </>
